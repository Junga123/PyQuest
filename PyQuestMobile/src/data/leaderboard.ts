...
const FAKE_USERS: { displayName: string; totalXp: number }[] = [
  ...
  { displayName: 'Айбулат Н.', totalXp: 3580 },
  { displayName: 'Мария В.', totalXp: 3010 },
  { displayName: 'Аббас А.', totalXp: 2470 },
  { displayName: 'Иван Л.', totalXp: 1990 },
  { displayName: 'Шамиль В.', totalXp: 1640 },
  { displayName: 'Екатерина Ж.', totalXp: 1280 },
  { displayName: 'Лилия Л.', totalXp: 960 },
