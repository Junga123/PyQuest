...
const makeStyles = (c: Palette) =>
  StyleSheet.create({
    ...
    stepCard: { backgroundColor: c.glass, borderRadius: radius.md, padding: spacing.md, marginTop: spacing.md, borderWidth: 1, borderColor: c.glassBorder },
    ...
    stackPanel: { backgroundColor: c.glass, borderRadius: radius.md, padding: spacing.sm, borderWidth: 1, borderColor: c.glassBorder },
    ...
    varsPanel: { backgroundColor: c.glass, borderRadius: radius.md, padding: spacing.md, borderWidth: 1, borderColor: c.glassBorder, minHeight: 50 },
    ...
    controls: { flexDirection: 'row', padding: spacing.md, gap: spacing.sm, borderTopWidth: 1, borderTopColor: c.glassBorder, backgroundColor: c.glassStrong },
    ctrl: { flex: 1 },
    ctrlSmall: { width: 52 },
  });
